...
- Cards are real webOS windows, managed by the card shell.

**LuneOS / Chromium only**
...
- Real-site load time is CPU-bound on first-party JS; the DFG JIT helps execution but page load stays
